...
import com.example.ui.theme.UiConstants.componentSpacingXS
import com.example.ui.theme.UiConstants.contentPaddingL
import com.example.ui.theme.UiConstants.screenMargin
...
fun MainScreen(viewModel: ActivityViewModel = viewModel()) {
    ...
    val levelColor = when (uiState.level) {
        ...
        Column(
            ...
            SpacerVertical(contentPaddingL)
        }
